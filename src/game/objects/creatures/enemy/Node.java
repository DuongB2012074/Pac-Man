...
import game.GameMap;
//làm nhiệm vụ lưu trữ tọa độ X và Y cho kẻ thù định hướng di chuyển tấn công
//hàm sử dụng giải thuật A* tìm đường đi ngắn nhất đến vị trí của player cho enemy
